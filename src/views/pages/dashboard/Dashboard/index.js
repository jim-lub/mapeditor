    ...
    <div>
      ...
      <div style={{float: "left", width: 400, margin: 10, padding: 10, border: "solid 1px #d5d5d5", backgroundColor: "#fff"}}>
        ...
        <div style={{margin: 5}}>
          ...
          around with the features currently implemented and leave any bugs you find on the publicly accessible <a href="https://github.com/jim-lub/mapeditor" target="_blank" rel="noopener noreferrer">github repo</a>.
