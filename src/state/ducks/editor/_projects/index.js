...
export const deleteProject = ({ projectId }) => operations.createProject({ projectId });
export const updateProject = ({ projectId, name, description }) => operations.createProject({ projectId, name, description });
